...
const AboutPage = () => {
  return (
    <>
      <Breadcrumb pageName="Privacy Policy" description="20-04-2024" />
      <section id="main" className="pt-4 md:pt-6 lg:pt-8">
        <div className="container">
          ...
          <ul>
            <li className="text-base  leading-relaxed  sm:text-lg sm:leading-relaxed">
              <p className="text-base  leading-relaxed  sm:text-lg sm:leading-relaxed">
            ...
            <li className="text-base  leading-relaxed  sm:text-lg sm:leading-relaxed">
              <p className="text-base  leading-relaxed  sm:text-lg sm:leading-relaxed">
                ...
                in this Agreement) refers to trisandya.
              </p>
            </li>
            <li className="text-base  leading-relaxed  sm:text-lg sm:leading-relaxed">
              <p className="text-base  leading-relaxed  sm:text-lg sm:leading-relaxed">
            ...
            <li className="text-base  leading-relaxed  sm:text-lg sm:leading-relaxed">
              <p className="text-base  leading-relaxed  sm:text-lg sm:leading-relaxed">
                <strong>Website</strong> refers to trisandya, accessible from{" "}
                <a
                  href="www.trisandya.com"
          ...
          <h4 className="my-2 text-xl font-bold text-black dark:text-white">
            Personal Data
          </h4>
          <p className="text-base  leading-relaxed  sm:text-lg sm:leading-relaxed">
          ...
          <ul>
            <li className="text-base  leading-relaxed  sm:text-lg sm:leading-relaxed">
              ...
              <a
                href="https://www.trisandya.com/contact"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://www.trisandya.com/contact
              </a>
            </li>
          </ul>
        </div>
